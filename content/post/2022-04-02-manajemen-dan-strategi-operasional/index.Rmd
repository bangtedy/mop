...
- Setiap organisasi agar tetap *exist* harus menciptakan nilai dalam bentuk solusi, produk dan jasa untuk pelanggan. Caranya adalah mentransformasikan sumberdaya yang dimiliki menjadi solusi yang dipakai oleh pelanggan.
- **Operasional** proses transformasi dari input menjadi output dengan tambahan nilai.
...
- The people who supervised their creation and delivery may not always be called ‘operations managers’, --> walaupun mereka tidak selalu disebut demikian. 
- Makul ini berkaitan tugas manajer operasi: the tasks, issues and decisions of those
operations managers who have made the services and products on which we all depend.
...
- Di dalam organisasi non profit, nilai dari outputnya (polisi, TNI, pemadam kebakaran) adalah nilai mereka pada masyarakat (keamanan, kenyamanan, dll); semakin besar nilai tambah yang diberikan, artinya semakin efektif operasi mereka. 
...
- Perusahaan menggunakan uang untuk yang diperoleh dari nilai tambah untuk kegiatan litbang, investasi fasilitas dan peralatan baru, gaji karyawan dan keuntungan.
...
Hampir semua operasi menghasilkan barang dan jasa
...
Keunggulan bersaing adalah penciptaan suatu sisten yang memiliki keunggulan khas dibanding para pesaing. Tujuannya adalah menciptakan nilai bagi pelanggan secara efisien dan berkelanjutan. 
  -> manajer operasi yang akan diminta mengimplementasikannya. 
  -> tiga cara untuk mencapainya: perbedaan/diferensiasi, biaya rendah (*low cost*), dan cepat tanggap (*quick response*).
